...
sys.path.append('/home/linaro/workspace/robot_ws/src/sophon_robot')
#from cfg import colorConfig
...
class image_converter:
  ...
  def __init__(self):
    ...
    self.image_pub2 = rospy.Publisher(self.topic_name+"/only_color/compressed",CompressedImage,queue_size=10)
  ...
  def callback(self,data):
    ...
    try:
      ...
      self.image_pub2.publish(self.bridge.cv2_to_compressed_imgmsg(res))
    except CvBridgeError as e:
      print(e)
