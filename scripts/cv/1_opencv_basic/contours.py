...
class image_converter:
  ...
  def __init__(self):
    ...
    self.image_pub = rospy.Publisher(self.topic_name+"/contours/compressed",CompressedImage,queue_size=10)
    self.image_pub2 = rospy.Publisher(self.topic_name+"/edges/compressed",CompressedImage,queue_size=10)
  ...
  def callback(self,data):
    ...
    try:
      ...
      self.image_pub2.publish(self.bridge.cv2_to_compressed_imgmsg(edges_img))
    except CvBridgeError as e:
      print(e)
